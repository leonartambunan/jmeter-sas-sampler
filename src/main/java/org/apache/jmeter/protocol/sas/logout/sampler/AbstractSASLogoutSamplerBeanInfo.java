...
public abstract class AbstractSASLogoutSamplerBeanInfo extends BeanInfoSupport {

    public AbstractSASLogoutSamplerBeanInfo(Class<? extends SASLogoutSampler> clazz) {
        super(clazz);
